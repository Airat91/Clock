...
#define PORT_LIN1       GPIOA
#define LIN2            GPIO_PIN_1
#define PORT_LIN2       GPIOA
#define LIN3            GPIO_PIN_2
#define PORT_LIN3       GPIOA
#define LIN4            GPIO_PIN_3
#define PORT_LIN4       GPIOA
#define STB1            GPIO_PIN_4
#define PORT_STB1       GPIOA
#define STB2            GPIO_PIN_5
#define PORT_STB2       GPIOA
#define STB3            GPIO_PIN_6
#define PORT_STB3       GPIOA
#define STB4            GPIO_PIN_7
#define PORT_STB4       GPIOA
